...
- [ ] 1. Set up project structure, configuration, and core models
  - [ ] 1.1 Create the PublicApiGateway project with solution file, NuGet dependencies, and directory structure
  ...
  - [ ] 1.2 Implement domain models and enums
  ...
  - [ ] 1.3 Implement configuration models and options registration
  ...
  - [ ] 1.4 Implement service interfaces
  ...
  - [ ] 1.5 Implement exception types and error code constants
...
- [ ] 2. Implement Security Hardening and Correlation ID middleware
  - [ ] 2.1 Implement SecurityHardeningMiddleware
  ...
  - [ ]* 2.2 Write property test for request size limit enforcement
    - **Property 17: Request size limit enforcement**
    - **Validates: Requirements 9.4, 9.5**

  - [ ] 2.3 Implement CorrelationIdMiddleware
  ...
  - [ ]* 2.4 Write property test for Correlation ID validation and passthrough
    - **Property 11: Correlation ID validation and passthrough**
    - **Validates: Requirements 6.2, 6.3**

  - [ ]* 2.5 Write property test for Correlation ID always present in response
    - **Property 12: Correlation ID always present in response**
    - **Validates: Requirements 6.6**

- [ ] 3. Implement API Key Authentication
  - [ ] 3.1 Implement IpBlockingService with Redis
  ...
  - [ ]* 3.2 Write property test for IP brute-force blocking
    - **Property 18: IP brute-force blocking at threshold**
    - **Validates: Requirements 9.6**

  - [ ] 3.3 Implement ApiKeyService with Redis cache and PostgreSQL fallback
  ...
  - [ ]* 3.4 Write property test for API key validation resolves correct tenant
    - **Property 1: API key validation resolves correct tenant and plan**
    - **Validates: Requirements 1.1, 1.6**

  - [ ]* 3.5 Write property test for invalid API keys rejection
    - **Property 2: Invalid API keys are always rejected**
    - **Validates: Requirements 1.3**

  - [ ] 3.6 Implement ApiKeyAuthenticationMiddleware
  ...
  - [ ]* 3.7 Write property test for API key format validation
    - **Property 16: API key format validation**
    - **Validates: Requirements 9.2, 9.3**

  - [ ]* 3.8 Write property test for API key masking in logs
    - **Property 19: API key masking in logs**
    - **Validates: Requirements 9.7**

- [ ] 4. Checkpoint - Ensure authentication pipeline compiles and tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Implement Rate Limiting
  - [ ] 5.1 Implement RateLimitService with Redis sliding window
  ...
  - [ ]* 5.2 Write property test for sliding window rate limiting
    - **Property 3: Sliding window rate limiting enforces plan-specific thresholds**
    - **Validates: Requirements 2.1, 2.2, 2.3, 2.6**

  - [ ]* 5.3 Write property test for rate limit header consistency
    - **Property 4: Rate limit headers are mathematically consistent**
    - **Validates: Requirements 2.7**

  - [ ] 5.4 Implement RateLimitingMiddleware
...
- [ ] 6. Implement Quota Enforcement
  - [ ] 6.1 Implement QuotaService with Redis atomic counter
  ...
  - [ ]* 6.2 Write property test for quota enforcement at boundary
    - **Property 5: Quota enforcement rejects at daily limit boundary**
    - **Validates: Requirements 3.1, 3.4**

  - [ ]* 6.3 Write property test for Retry-After calculation
    - **Property 6: Retry-After calculation correctness**
    - **Validates: Requirements 3.2**

  - [ ] 6.4 Implement QuotaEnforcementMiddleware
    - Retrieve TenantContext from HttpContext.Items
    - Call IQuotaService.IncrementAndCheckAsync
    - On rejection: return 429 with GW-QUOTA-001 and Retry-After header
    - _Requirements: 3.1, 3.2, 3.5_

- [ ] 7. Implement Request Forwarding and Response Handling
  - [ ] 7.1 Implement TokenService for OAuth 2.0 client credentials
  ...
  - [ ] 7.2 Implement RequestForwardingMiddleware
  ...
  - [ ]* 7.3 Write property test for request forwarding content preservation
    - **Property 9: Request forwarding preserves content and strips sensitive headers**
    - **Validates: Requirements 5.1, 5.3, 5.4**

  - [ ]* 7.4 Write property test for response forwarding
    - **Property 10: Response forwarding preserves upstream response**
    - **Validates: Requirements 5.5**

  - [ ]* 7.5 Write property test for non-conforming upstream error wrapping
    - **Property 15: Non-conforming upstream errors are wrapped**
    - **Validates: Requirements 7.4**

- [ ] 8. Checkpoint - Ensure request pipeline compiles and tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Implement Usage Metering
  - [ ] 9.1 Implement UsageMeteringService with Channel<T> and background consumer
  ...
  - [ ] 9.2 Implement UsageMeteringBackgroundService
  ...
  - [ ]* 9.3 Write property test for usage record completeness
    - **Property 7: Usage record completeness**
    - **Validates: Requirements 4.1**

  - [ ]* 9.4 Write property test for usage buffer non-blocking FIFO eviction
    - **Property 8: Usage buffer is non-blocking with FIFO eviction**
    - **Validates: Requirements 4.5, 4.7**

  - [ ] 9.5 Wire usage metering into the middleware pipeline
...
- [ ] 10. Implement Error Response Handling
  - [ ] 10.1 Implement global exception handler middleware
  ...
  - [ ]* 10.2 Write property test for error response schema conformance
    - **Property 13: Error response schema conformance**
    - **Validates: Requirements 7.1, 7.2, 7.6, 7.7, 7.8**

  - [ ]* 10.3 Write property test for no internal details leak
    - **Property 14: No internal details leak in error responses**
    - **Validates: Requirements 7.5**

- [ ] 11. Implement Health Checks and Observability
  - [ ] 11.1 Implement health check endpoints and dependency checks
  ...
  - [ ] 11.2 Configure OpenTelemetry tracing and structured logging
  ...
  - [ ] 11.3 Configure Prometheus metrics endpoint
    - Expose `GET /metrics` with total requests, requests per tenant, error rates, p50/p95/p99 latency
    - _Requirements: 8.7_

- [ ] 12. Wire up Program.cs and DI registration
  - [ ] 12.1 Implement ServiceCollectionExtensions and compose the application
  ...
  - [ ]* 12.2 Write integration tests with Testcontainers
